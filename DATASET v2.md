...
classDef rootStyle fill:#0b1020,stroke:#f59e0b,stroke-width:4px,color:#f8fafc,font-weight:bold,font-size:18px;
classDef divisionStyle fill:#111827,stroke:#22d3ee,stroke-width:3px,color:#e2e8f0,font-weight:bold,font-size:14px;
classDef categoryStyle fill:#0f172a,stroke:#f97316,stroke-width:2.5px,color:#fde68a,font-weight:bold,font-size:13px;
classDef cityStyle fill:#0ea5e9,stroke:#38bdf8,stroke-width:2px,color:#e0f2fe,font-weight:bold;
classDef foodStyle fill:#22c55e,stroke:#86efac,stroke-width:2px,color:#ecfdf5,font-weight:bold;
classDef placeStyle fill:#f59e0b,stroke:#fbbf24,stroke-width:2px,color:#fffbeb,font-weight:bold;
classDef personStyle fill:#ef4444,stroke:#fca5a5,stroke-width:2px,color:#fff1f2,font-weight:bold;
classDef infoStyle fill:#0b1222,stroke:#94a3b8,stroke-width:1.5px,color:#e2e8f0,font-size:11px;
